...
public class CustomActivity extends AndARActivity
{
	...
	try
	{
	    ...
	    someObject1 = new CustomObject1("test1", "patt.hiro", 80.0, new double[]
	    {
	    0, 0
	    }, new float[]
	    {
	    245 / 255f, 98 / 255f, 10 / 255f
	    });
	    artoolkit.registerARObject(someObject1);
	    someObject = new CustomObject("test", "android.patt", 80.0, new double[]
	    {
	    0, 0
	    });
	    artoolkit.registerARObject(someObject);
	    /*someObject = new CustomObject("test", "barcode.patt", 80.0, new double[]
	    {
	    0, 0
	    });
	    artoolkit.registerARObject(someObject);*/
